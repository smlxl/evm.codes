...
function getCompile(compilerVersion) {
  importScripts(`https://binaries.soliditylang.org/bin/${compilerVersion}.js`)

  // Code extracted from https://github.com/ethereum/solc-js/blob/v0.8.15/wrapper.js
...
onmessage = function (e) {
  switch (e.data.type) {
    case 'loadVersion':
      compile = getCompile(e.data.compilerVersion)
      break
    case 'compile':
      if (!e.data.source) {
