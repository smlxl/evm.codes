...
export const H1: React.FC<Props> = ({ children, className }) => {
  return (
    <h1
      className={cn(
        'text-2xl md:text-3xl max-w-3xl font-medium leading-relaxed text-center mx-auto mb-8 md:mb-16',
        className,
      )}
    >
      {children}
...
export const H2: React.FC<Props> = ({ children, className }) => {
  return <h2 className={cn('font-medium text-xl', className)}>{children}</h2>
}
