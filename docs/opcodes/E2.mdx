...
0. `max_index`: immediate argument the maximum index in the jump table - list of relative offset which one of them will be the point where execution will continue from.
1. `jump_table`: list of relative offsets in the deployed [code](/about).
